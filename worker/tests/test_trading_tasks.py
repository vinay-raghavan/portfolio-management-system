...
class TestMarketHoursHelpers:
    ...
    def test_market_times_constants(self):
        ...
        assert MARKET_OPEN_TIME == time(9, 15)
        assert MARKET_CLOSE_TIME == time(15, 30)
        assert INTRADAY_SQUARE_OFF_TIME == time(15, 15)
...
class TestCheckSLTPOrders:
    ...
    def test_calls_api_when_market_open(self):
        ...
        with patch('worker.tasks.trading.is_market_hours', return_value=True):
