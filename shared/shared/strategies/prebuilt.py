...
def create_rsi_macd_confluence() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            {"strategy": "rsi", "params": {"oversold_threshold": 30, "overbought_threshold": 70}, "weight": 1.0, "required": True},
            {"strategy": "macd", "params": {"fast_period": 12, "slow_period": 26, "signal_period": 9}, "weight": 1.0, "required": True},
        ],
        combine_logic="AND",
...
def create_trend_momentum_pullback() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            {"strategy": "moving_average", "params": {"fast_period": 20, "slow_period": 50}, "weight": 1.5, "required": True},
            {"strategy": "rsi", "params": {"oversold_threshold": 40, "overbought_threshold": 60}, "weight": 1.0, "required": True},
        ],
        combine_logic="AND",
        min_combined_confidence=0.5,
...
def create_bollinger_rsi_squeeze() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            {"strategy": "bollinger_bands", "params": {"squeeze_percentile": 20, "lookback_periods": 50}, "weight": 1.5, "required": True},
            {"strategy": "rsi", "params": {"oversold_threshold": 45, "overbought_threshold": 55}, "weight": 1.0, "required": False},
        ],
        combine_logic="AND",
        min_combined_confidence=0.5,
        risk_reward_ratio=2.0,
...
def create_triple_confirmation() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            {"strategy": "rsi", "params": {"oversold_threshold": 35, "overbought_threshold": 65}, "weight": 1.0},
            {"strategy": "macd", "params": {}, "weight": 1.0},
            {"strategy": "moving_average", "params": {"fast_period": 10, "slow_period": 30}, "weight": 1.0},
        ],
...
def create_intraday_momentum() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            ...
            {"strategy": "vwap_reversion", "params": {"require_band_touch": False}, "weight": 1.0, "required": False},
        ],
        combine_logic="AND",
        min_combined_confidence=0.5,
        risk_reward_ratio=2.0,
...
def create_gap_momentum() -> CompositeStrategy:
    ...
    return CompositeStrategyFactory.create(
        ...
        components=[
            {"strategy": "gap_go", "params": {"min_gap_pct": 1.0, "max_gap_pct": 5.0}, "weight": 1.5, "required": True},
            {"strategy": "rsi", "params": {"oversold_threshold": 45, "overbought_threshold": 55}, "weight": 1.0, "required": False},
        ],
        combine_logic="AND",
        min_combined_confidence=0.5,
