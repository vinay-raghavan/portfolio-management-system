...
async def check_data_provider_health() -> dict[str, str]:
    ...
    try:
        ...
        # Try to get a simple quote to verify connectivity
        # Use a well-known symbol that should always be available
        ...
        return {"status": "error", "provider": _get_provider_name(), "error": str(e)}
