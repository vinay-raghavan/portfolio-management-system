...
Revises: 20260212_0900_add_research_data_provider_setting
...
def upgrade() -> None:
    ...
    op.add_column(
        "watchlists", sa.Column("sort_order", sa.Integer(), nullable=False, server_default="0")
    )
    # Add sort_order column to watchlist_items table
    op.add_column(
        "watchlist_items", sa.Column("sort_order", sa.Integer(), nullable=False, server_default="0")
    )
