...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("position_sizing_method", sa.Enum("FIXED_QUANTITY", "FIXED_AMOUNT", "PERCENT_OF_PORTFOLIO", "RISK_BASED", name="positionsizingmethod", create_type=False), nullable=False, server_default="PERCENT_OF_PORTFOLIO"),
        ...
        sa.Column("product_type", sa.Enum("DELIVERY", "INTRADAY", "MTF", name="strategyproducttype", create_type=False), nullable=False, server_default="DELIVERY"),
    ...
    op.create_table(
        ...
        sa.Column("confirmation_mode", sa.Enum("auto", "notify", "disabled", name="confirmationmode", create_type=False), nullable=False, server_default="notify"),
        ...
        sa.Column("screener_source_type", sa.Enum("preset", "custom", name="screenersourcetype", create_type=False), nullable=False, server_default="preset"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "approved", "rejected", "expired", "executed", name="pendingtradestatus", create_type=False), nullable=False, server_default="pending"),
