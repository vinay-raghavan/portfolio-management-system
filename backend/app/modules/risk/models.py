...
class RiskLimits(Base):
    ...
    max_position_size: Mapped[Decimal] = mapped_column(
        Numeric(18, 4),
        nullable=False,
        default=Decimal("100000"),  # ₹1 Lakh default
    )
    max_position_pct: Mapped[Decimal] = mapped_column(
        Numeric(5, 2),
        nullable=False,
        default=Decimal("20"),  # 20% of portfolio
    )
    max_positions: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        default=20,  # Max 20 open positions
    )
    ...
    max_sector_concentration: Mapped[Decimal] = mapped_column(
        Numeric(5, 2),
        nullable=False,
        default=Decimal("40"),  # Max 40% in one sector
    )
    ...
    max_daily_loss: Mapped[Decimal] = mapped_column(
        Numeric(18, 4),
        nullable=False,
        default=Decimal("50000"),  # ₹50K default
    )
    max_daily_loss_pct: Mapped[Decimal] = mapped_column(
        Numeric(5, 2),
        nullable=False,
        default=Decimal("5"),  # 5% of portfolio
    )
    ...
    max_intraday_exposure: Mapped[Decimal] = mapped_column(
        Numeric(18, 4),
        nullable=False,
        default=Decimal("500000"),  # ₹5 Lakh default intraday exposure
    )
    ...
    max_order_value: Mapped[Decimal] = mapped_column(
        Numeric(18, 4),
        nullable=False,
        default=Decimal("50000"),  # ₹50K per order
    )
    max_orders_per_day: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        default=50,  # Max 50 orders per day
    )
    ...
    auto_square_off_intraday: Mapped[bool] = mapped_column(
...
class DailyRiskMetrics(Base):
    ...
    # Risk breach flags
    daily_loss_limit_breached: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    position_limit_breached: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
