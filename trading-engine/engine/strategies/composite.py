...
class CompositeStrategy(BaseStrategy):
    ...
    def _combine_signals(
        ...
        # Determine final signal based on combine logic
    ...
    def _determine_signal(
        ...
        Returns:
            Tuple of (signal_type, strength, confidence, notes)
        """
    ...
    def _combine_or(
        ...
        # Prefer the signal with highest combined strength
...
class CompositeStrategyFactory:
        ...
        **kwargs,
        ...
        Args:
            ...
            components: List of component dicts with keys:
                ...
                - required: Optional required flag (default False)
            combine_logic: "AND", "OR", "MAJORITY", or "WEIGHTED"
            **kwargs: Additional CompositeStrategy parameters
    ...
    def register(strategy: CompositeStrategy) -> CompositeStrategy:
        ...
        Args:
            strategy: CompositeStrategy instance

        Returns:
            The registered strategy
        """
        # Create a class dynamically for registration
        strategy_class = type(
